...
console.log(theMap)
/* -------------------------------------------------------------------- */
/* Работа с Set! прикол в том что они не повтаряются! 0.10v! */
/* JavaScript: */
let mySet = new Set(
    ['Меч','Зелье','Меч','Щит','Зелье','Лук',]
)

console.log(`Количество вещей: ${mySet.size}`);
mySet.has('Щит') ? console.log('Щит найден!') : console.log('Щита нет в инвентаре!');
mySet.add('Арбалет');
console.log(mySet)
